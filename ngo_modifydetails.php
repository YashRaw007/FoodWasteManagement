...
$details = "SELECT * FROM ngo_details WHERE id LIKE '$nid'";
...
if(isset($_POST['subaddr'])){
    ...
    $que = "UPDATE ngo_details SET `address` = '$addr' WHERE id LIKE '$nid'";
...
if(isset($_POST['subph'])){
    $phno = $_POST['phno'];
    $que = "UPDATE ngo_details SET phno = '$phno' WHERE id LIKE '$nid'";
    $exe = mysqli_query($conn, $que);
    if($exe){
        ?>
            <script>
...
if(isset($_POST['subph2'])){
    $phno2 = $_POST['phno2'];
    $que = "UPDATE ngo_details SET phno2 = '$phno2' WHERE id LIKE '$nid'";
    $exe = mysqli_query($conn, $que);
    if($exe){
        ?>
            <script>
...
if(isset($_POST['submail'])){
    ...
    $que = "UPDATE ngo_details SET email= '$email' WHERE id LIKE '$nid'";
    $exe = mysqli_query($conn, $que);
    if($exe){
        ?>
            <script>
...
if(isset($_POST['subpass'])){
    ...
    if($npass == $cpass){
        if($pass_decode){
            $upd = "UPDATE ngo_details SET pass = '$password' WHERE id LIKE '$nid' ";
        ...
        <div class="row vh-100 overflow-auto">
            ...
            <div class="col d-flex flex-column h-100">
                ...
                <footer class="row bg-dark text-white text-center p-3 mt-auto">
                    <div class="col"> Developed by <u>V Viswanath Rao</u> , <u>SREE NANDHAN P</u> & <u>Yashasvi Rawat</u> </div>
                </footer>
            </div>
        </div>
    </div>

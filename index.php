...
<body style="background-color: #222222;color: white;font-family: 'Noto Sans', sans-serif;">
    ...
    <div class="mx-4 my-2 py-4" id="contact">
        ...
        <div>
            <p>
            <h4 class="gold-color">V Viswanath Rao</h4>
            parthiviswanath.rao2020@vitstudent.ac.in<br>
            20BCE2712<br>
            </p>
            <p>
            <h4 class="gold-color">SREE NANDHAN P</h4>
            sreenandhan.p2020@vitstudent.ac.in<br>
            20BCE2703<br>
            </p>
            <p>
            <h4 class="gold-color">Yashasvi Rawat</h4>
            yashasvi.rawat2020@vitstudent.ac.in<br>
            20BCE2288<br>
            </p>
        </div>
    </div>
